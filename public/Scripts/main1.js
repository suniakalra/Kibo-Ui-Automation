  ...
  $("#btnRun, #btnReRun, #btnRunAll").attr("disabled","disabled").css({"color":"black"});
   ...
   xmlDoc.writeAttributeString('name',$("#selectTypes").val());
        xmlDoc.writeStartElement('parameter');
            xmlDoc.writeAttributeString('name','SYSTEMUNDERTEST');
            xmlDoc.writeAttributeString('value',$("#selectUrl").val());
        xmlDoc.writeEndElement();
        xmlDoc.writeStartElement('parameter');
            xmlDoc.writeAttributeString('name','GRIDHOST');
            xmlDoc.writeAttributeString('value',$("#selectIPAddress").val());
        xmlDoc.writeEndElement();
        xmlDoc.writeStartElement('parameter');
            xmlDoc.writeAttributeString('name','PLATFORM');
            xmlDoc.writeAttributeString('value','WINDOWS');
        xmlDoc.writeEndElement();
        xmlDoc.writeStartElement('test');
            xmlDoc.writeAttributeString('name',$("#selectBrowser").val());
            xmlDoc.writeStartElement('parameter');
                xmlDoc.writeAttributeString('name', 'BROWSER');
                xmlDoc.writeAttributeString('value',$("#selectBrowser").val());
            xmlDoc.writeEndElement();
            xmlDoc.writeStartElement('parameter');
                xmlDoc.writeAttributeString('name','VERSION');
                xmlDoc.writeAttributeString('value','ANY');
            xmlDoc.writeEndElement();
